...
<div  id="searchResults" class=" d-flex gap-5 justify-content-center flex-wrap mt-4 ">
    ...
    <?php if(isset($_SESSION['role']) && $_SESSION['role'] == 'admin'){  ?>
        <a href="<?php echo URLROOT; ?>/admins/archive/<?php echo $wiki->id_wiki ?>" class=" my-2 "> <button class="btn btn-outline-danger btn-sm w-100 text-decoration-none ">
        ...
        <a href="<?php echo URLROOT; ?>/users/contenu/<?php echo $wiki->id_wiki; ?>"><img src="<?php echo URLROOT; ?>/image/art.jpg" alt="img" class="edito-poster shadow-sm rounded" height="5"></a>
        ...
        <p class="truncate-text my-1"><?php echo $wiki->contenu ;?></p>
            <p class="fs-6 orange1 fw-bold m-0 ">Tags : <span class=" fw-medium text-success"><?php foreach($data['wikitags'][$wiki->id_wiki] as $tag) : ?>#<?php echo $tag->tag_name ;?>/ <?php endforeach; ?></span></p>
                ...
                <a href="<?php echo URLROOT; ?>/auteurs/editWiki/<?php echo $wiki->id_wiki; ?>" class=" my-2 "> <button class="btn btn-outline-success btn-sm  text-decoration-none ">
           ...
           <a href="<?php echo URLROOT; ?>/auteurs/deleteWiki/<?php echo $wiki->id_wiki; ?>" class=" my-2 "> <button class="btn btn-outline-danger   btn-sm   text-decoration-none ">
