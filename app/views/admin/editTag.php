                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-2 px-lg-4 text-black">
                                    ...
                                    <form method="post" action="<?php echo URLROOT; ?>/admins/editTag/<?php echo $data['id'] ?>">
                                        ...
                                        <h5 class="fw-semibold mb-3 pb-3" style="letter-spacing: 1px;">Modifier Tag</h5>

                                        <div class="form-floating mb-4">
                                            <input type="text" class="form-control" name="nameTag"  value="<?php echo $data['nameTag'] ?>"
                                                placeholder="name@example.com">
                                            <label for="floatingInput" class="text-secondary">Nom Catégorie </label>
                                            <span class="ms-2 text-danger" ><?php echo $data['nameTag_err'] ?></span>
                                        </div>
